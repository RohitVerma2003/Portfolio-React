      ...
      <div className='w-full md:w-1/2 mx-2 py-[20%] md:py-[8%]'>
        ...
        <div className='flex justify-center flex-wrap md:flex-nowrap items-center my-10 top-16 gap-5'>
          ...
          <div className='w-3/4 md:w-1/2 h-2/3 text-justify'>
            <p className='text-mid-blue font-light mt-3'>
              👋 Hello there!{' '}
              <span className='text-white font-base'>I'm Rohit Verma</span>, a
              B.Tech CS student.
            </p>
            <p className='text-mid-blue font-light mt-3'>
              👋I'm all about{' '}
              <span className='text-white font-base'>coding</span> and{' '}
              <span className='text-white font-base'>problem-solving</span>.
            ...
            <p className='text-mid-blue font-light mt-3'>
              Seeking opportunities to expand my{' '}
              <span className='text-white font-base'>
                skills and connect with fellow tech enthusiasts
              </span>
              . Let's chat and explore the exciting possibilities in the world
              of computer science!
            </p>
          </div>
        </div>
        <div className='h-[600px]'>
          ...
          <div className='text-white'>
            ...
            <p>
              <a
                ...
                target='_blank'
                className='w-min font-light border-b px-1'
              >
                ISRO
              </a>{' '}
              <span className='text-mid-blue font-extralight'> - Hackathon</span>
            </p>
            <p className='text-mid-blue font-light pt-3'>
              Oct 2024 - Dec 2024 · 3 mos
            </p>
          </div>
          <div className='text-white'>
            <p className='pt-8 pb-3 text-lg'>C++ Developer - Internship</p>
            <p>
              <a
              ...
              <span className='text-mid-blue font-extralight'> - Virtual</span>
            </p>
            <p className='text-mid-blue font-light pt-3'>
          ...
          <div className='text-white'>
            ...
            <p>
              <a
                href='https://www.papercodetech.com/'
                target='_blank'
                className='w-min font-light border-b px-1'
              >
                Paper Code Technologies
              </a>{' '}
              <span className='text-mid-blue font-extralight'> - Remote</span>
            </p>
            <p className='text-mid-blue font-light pt-3'>
          ...
          <div className='text-white'>
            ...
            <p>
              <span className='w-min font-light border-b px-1'>
                Abdul Kalam Technical University
              </span>{' '}
              <span className='text-mid-blue font-extralight'>
                {' '}
                - Agra, Uttar Pradesh
              </span>
            </p>
