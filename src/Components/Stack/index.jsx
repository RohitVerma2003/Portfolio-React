    ...
    return (
        <div className='w-full h-[73%] md:h-[83%] flex justify-center'>
            <div className='w-full md:w-1/2 mx-2 py-[20%] md:py-[17%]'>
                <p className='text-center font-semibold text-4xl text-white mb-9'>The Text Stack I work with.</p>
                <p className='text-center font-light text-mid-blue text-2xl'>C++ , React.js , MongoDB , Express.js , Node.js , HTML , CSS , Javascript , Git , C , Postman</p>
