    ...
    return (
        <div className='w-full h-[73%] md:h-[83%] flex justify-center'>
            <div className='w-full md:w-1/2 mx-2 py-[20%] md:py-[17%]'>
                ...
                <p className='text-center font-light text-mid-blue text-2xl'>C++ , C , JavaScript , NodeJS , React , MongoDB , Git , ExpressJS , HTML , CSS , Tailwind , Bootstrap , Socket.io, React Native, Expo</p>
